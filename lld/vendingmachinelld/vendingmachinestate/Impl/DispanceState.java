...
public class DispanceState implements State{
    ...
    public DispanceState(){
        System.out.println("Currently Vending machine is in DispenseState");
    }
    public DispanceState(VendingMachine machine,int codeNumber) throws Exception{
        System.out.println("Currently Vending machine is in DispenseState");
        dispanceItem(machine,codeNumber);
    }
    ...
    public Item dispanceItem(VendingMachine machine, int codeNumber) throws Exception {
        System.out.println("Product has been dispanse");
        Item item = machine.getInventory().getItem(codeNumber);
        machine.getInventory().updateitem(codeNumber);
